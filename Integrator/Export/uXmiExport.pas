...
//  Write( '<' + CoreModelElement + 'documentation xmi.value="' + E.Documentation.Description + '"/>');
  if E.Documentation.Description<>'' then
  begin
    Write( XmlOpen( CoreModelElement + 'documentation') );
    Write( E.Documentation.Description );
    Write( XmlClose( CoreModelElement + 'documentation') );
  end;
end;
